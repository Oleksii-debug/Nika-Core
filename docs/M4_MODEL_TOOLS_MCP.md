...
6. one total deadline is preserved across all attempts; raw provider `TimeoutError` cannot masquerade as the gateway deadline; typed timeout fallback remains blocked when hard cancellation is unproven;
