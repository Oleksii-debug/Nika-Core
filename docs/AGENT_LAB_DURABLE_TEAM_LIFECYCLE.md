...
Current base main: `017ac3d58cd79df491ad3a23eb2ba99fb26d1e13`.
Original branch base: `f161a48b58cd7df8f247a5c99aadb8a6f34de712`.
Branch: `fix/agent-lab-durable-team-lifecycle`.
Backups: `backup/auto03-durable-team-lifecycle-2356af26` and `backup/auto03-durable-team-lifecycle-babcc41f`.

## Main-line compatibility refresh

AUTO04 PR #52 changed only M12 workflow trigger semantics and the QA lineage regression. AUTO02 PR #49 changed model/Foundry readiness plus related CI workflow files. AUTO01 PR #51 added crash-safe SQLite backup/recovery under `src/nika_core/reliability` plus its focused tests/docs. All three are intentionally included in this candidate's base so exact-head acceptance runs against current main. None overlaps AUTO03 `multi_agent` source or the lifecycle regression files.
