...
Base main: `0ca6894850ac775a83826a55b39364b44caa2fd3`.
...
Intermediate refreshed head: `fb35e907516364a8669eaa0c3c3333a91aab85aa` (preserved as `backup/auto03-agent-lab-evaluation-fb35e907`).

## QA lineage refresh

AUTO04 PR #48 demonstrated that the previous Core/M11/M12 workflows could implicitly test GitHub's pull-request merge ref while labeling evidence with the PR head SHA. The old AUTO03 gate is therefore not acceptance evidence. This refreshed candidate is based directly on the repaired main, including the subsequently integrated Windows desktop backend from PR #46, and must pass the new explicit exact-SHA workflows before integration.
