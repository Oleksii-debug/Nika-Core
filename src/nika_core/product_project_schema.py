...
PRODUCT_PROJECT_SCHEMA_VERSION = 1
...
PRODUCT_PROJECT_MIGRATIONS: dict[int, tuple[str, ...]] = {
    1: (
        ...
        "CREATE INDEX IF NOT EXISTS idx_product_projects_status ON product_projects(status, updated_at)",
        "CREATE INDEX IF NOT EXISTS idx_product_project_specs_latest ON product_project_specs(project_id, spec_version DESC)",
    ),
}
