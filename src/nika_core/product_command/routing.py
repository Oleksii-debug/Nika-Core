...
def route_command(text: str, *, active_project_id: str | None = None) -> CommandRouteDecision:
    ...
    This is intentionally conservative. It only recognizes high-confidence factory/toolsmith
    language; everything else stays an ordinary AgentTask. Mixed high-confidence intents are
    surfaced as ambiguous instead of silently choosing a high-impact long-lived project path.
    """
