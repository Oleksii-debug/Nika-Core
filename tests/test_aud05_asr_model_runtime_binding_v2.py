...
def test_checksum_approved_runtime_uses_verified_bytes_after_source_replacement(
    ...
    def mutate_source_then_import(package: str) -> object:
        ...
        # Mutate the original caller-owned model path after the checksum/snapshot boundary.
        # Safe implementations may fail closed before import or may continue only by giving
        # the runtime independently bound verified bytes.
