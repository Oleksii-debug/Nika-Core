...
def test_aud05_candidate_timestamp_mutation_cannot_gain_selection_authority() -> None:
    p = _protocol()
    candidate = _score()
...
def test_aud05_selection_timestamp_mutation_cannot_gain_bind_authority() -> None:
    p = _protocol()
...
def test_aud05_protocol_mutation_cannot_redefine_partition_chronology() -> None:
    p = _protocol()
