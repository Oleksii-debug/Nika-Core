...
_TEST_AUTHORIZATION = ToolAuthorization(
    tool_id="publish",
    task_id="unused",
    risk=ToolRisk.EXTERNAL_SIDE_EFFECT,
    arguments_fingerprint="unused",
    effect_fingerprint="test-effect-v1",
    approval_fingerprint="test-approval-v1",
)
...
async def _approve(spec: ToolSpec, call: ToolCall) -> ToolAuthorization:
    ...
    return ToolAuthorization(
        ...
        effect_fingerprint=_TEST_AUTHORIZATION.effect_fingerprint,
        approval_fingerprint=_TEST_AUTHORIZATION.approval_fingerprint,
    )
...
def test_external_tool_requires_durable_guard_even_when_approved() -> None:
    ...
    executor = ToolExecutor(approval_policy=_approve)
...
def test_completed_external_tool_replays_after_restart_without_second_effect(
    ...
    first = ToolExecutor(approval_policy=_approve, effect_guard=guard)
    ...
    restarted = ToolExecutor(approval_policy=_approve, effect_guard=restarted_guard)
